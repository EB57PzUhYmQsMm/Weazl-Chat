...
document.onpaste = function(event) {
	...
	if (blob !== null) {
		...
		reader.onload = function(event) {
			var filedata = { "content": event.target.result, "name": filename, "type": extension, "size": filesize }
...
function handleFileSelect(event) {
	...
	reader.onload = function(event) {
		...
		document.getElementById("fileUploadStatus").innerHTML = "Uploading a file of this size (" + filesize + " MB) may take up to " + ctime + " seconds...";
	};
